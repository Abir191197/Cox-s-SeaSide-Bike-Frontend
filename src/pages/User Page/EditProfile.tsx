...
import { useUpdatedUserDataMutation } from "../../redux/api/auth API Management/UpdateUser";
import Loading from "../../components/Loading";

export default function EditProfile() {
  const { data, isLoading } = useGetWhoLoginQuery(undefined);
  const [updateProfile] = useUpdatedUserDataMutation();
  ...
  return (
    <div className="space-y-10 divide-y divide-gray-900/10 ms-96">
      <div className="grid grid-cols-1  gap-y-8 pt-10 md:grid-cols-3">
        <form
